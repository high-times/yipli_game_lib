...
public class YipliConfig : ScriptableObject
{
    ...
    [Header("test environement variables")]
    public bool dataReseted = false;

    // methods
    public void ResetThisObjectsData()
    {
        currentMatID = string.Empty;
        pId = string.Empty;
        isDeviceAndroidTV = false;
        skipNormalUpdateClicked = false;
        getMatUrlIn = string.Empty;
        getMatUrlUS = string.Empty;
        allowMainGameSceneToLoad = false;
        sceneLoadedDirectly = false;
        onlyMatPlayModeIsSet = false;
        troubleshootingPOSTDone = false;
        bIsChangePlayerCalled = false;
        onlyMatPlayMode = true;
        userId = "";
        gameId = "";
        callbackLevel = "";
    }
