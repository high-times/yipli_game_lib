...
{
    public class HTTPNewUIManager : MonoBehaviour
    {
        // required variables
        [Header("UI Elements")]
        ...
        [SerializeField] private HTTPMatManager matSelection = null;
        ...
        public void MainButtonFucntion() {
            switch(currentPanelTag) {
                ...
                case noMatPanel:
                    if (currentyipliConfig.AllUrls.YipliWebUrlIN == null || currentyipliConfig.AllUrls.YipliWebUrlUS == null) {
                        if (System.Globalization.RegionInfo.CurrentRegion.ToString().Equals("IN", System.StringComparison.OrdinalIgnoreCase)) {
                            Application.OpenURL(currentyipliConfig.AllUrls.YipliWebUrlIN);
                        } else {
                            Application.OpenURL(currentyipliConfig.AllUrls.YipliWebUrlUS);
                        }
                    } else {
                        if (System.Globalization.RegionInfo.CurrentRegion.ToString().Equals("IN", System.StringComparison.OrdinalIgnoreCase)) {
